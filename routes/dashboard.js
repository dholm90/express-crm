...
const user_controller = require('../controllers/owner/userController');
const client_controller = require('../controllers/owner/clientController');
const material_controller = require('../controllers/owner/materialController');
const invoice_controller = require('../controllers/owner/invoiceController');
const service_controller = require('../controllers/owner/serviceController');
const quote_controller = require('../controllers/owner/quoteController');
const job_controller = require('../controllers/owner/jobController');
const image_controller = require('../controllers/owner/imageController');
const dashboard_controller = require('../controllers/owner/dashboardController');
const stripe_controller = require('../controllers/owner/stripeController');
const expense_controller = require('../controllers/owner/expenseController');
const hours_controller = require('../controllers/owner/hoursController');
...
router.get('/email-success', function (req, res, next) {
  res.render('dashboard/email-success', {
    title: 'Email Sent!',
    parent_page: 'None',
...
// Expenses list
router.get('/expense-list', expense_controller.expense_list);
...
// toggle paid
router.post('/expense/:id/toggle-paid', expense_controller.toggle_paid);

/////////////// Hours //////////////////

// Hours List
router.get('/hours-list', hours_controller.hours_list)

// toggle paid

router.post('/hour-log/:id/toggle-paid', hours_controller.toggle_paid)
...
/////////////// Category Routes /////////////
router.get('/category-list', category_controller.category_list);
