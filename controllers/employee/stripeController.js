...
exports.subscription_session = async (req, res, next) => {
  try {
    ...
    const session = await stripe.checkout.sessions.create({
      ...
      line_items: [
        {
          price: 'price_1MbyOjFKkfufUD6uiXJu4xnH',
      ...
      mode: 'subscription',
      success_url: `https://bearquotes.com/dashboard/business-detail`,
    ...
    const session = await stripe.checkout.sessions.create(
      {
        ...
        success_url: 'https://bearquotes.com/employee',
        cancel_url: 'https://bearquotes.com/employee',
      },
      { stripeAccount: business.stripeAcctID }
    );
