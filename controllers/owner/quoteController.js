...
exports.quote_list = (req, res, next) => {
  Quote.find({ business: req.user.business })
    ...
    .exec(function (err, quote_list) {
      ...
      res.render('dashboard/quote-list', {
        title: 'Quotes',
        parent_page: 'Quotes',
...
exports.quote_detail = (req, res, next) => {
  async.parallel(
    ...
    async (err, results) => {
      ...
      await res.render('dashboard/quote-detail', {
...
exports.create_quote_get = (req, res, next) => {
  Client.find({ business: req.user.business })
    ...
    .exec(function (err, clients) {
      ...
      res.render('dashboard/quote-form', {
        title: 'New Quote',
        parent_page: 'Quotes',
        layout: './layouts/dashboard',
        clients,
...
exports.create_quote_post = [
  ...
  (req, res, next) => {
    ...
    const quoteData = new Quote({
      ...
      res.redirect(`/dashboard/quote-list`);
    })
  }
]
    ...
    if (!errors.isEmpty()) {
      async.parallel(
        ...
        (err, results) => {
          ...
          res.render('dashboard/quote-detail', {
            title: `Quote: ${results.quote.title}`,
            parent_page: 'Quotes',
            layout: './layouts/dashboard',
            quote: results.quote,
...
exports.sign_off = async (req, res, next) => {
  ...
  if (job) {
    ...
    await res.redirect('/dashboard/job-list');
  }
